    ...
    <>
      <form onSubmit={(e) => handleSubmit(e)} style={{ height: '300px' }}>
        ...
        <div className='flex justify-between items-center'>
          <button type='submit' className='w-1/2 font-bold text-white bg-green-400 p-2 rounded-md'>Login</button>
          <Link to='/auth/register' className='cursor-pointer'>{'Not have account?'}</Link>
        </div>
